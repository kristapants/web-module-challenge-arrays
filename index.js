...
function copy(arr, fillArr){
    fillArr = [...arr];
    return fillArr;
}

rotatingMenu = [...originalFlavors]//copy(originalFlavors, rotatingMenu);
//console.log(rotatingMenu)
//this question is bad and poorly worded. My code is messy and gross to meet the requirements of the question
...
function filterByWord(arr, _flavor){
    let newArr = []
    for(let i = 0; i < arr.length; i++){
        if(arr[i].includes(_flavor)){
            newArr.push(arr[i]);
        }
    }
    return newArr
